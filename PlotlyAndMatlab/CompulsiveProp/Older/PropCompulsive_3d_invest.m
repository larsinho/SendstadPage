...
zlabel('Relative value of leader vs. monopolist','FontName','Times','Interpreter','latex','units','normalized');
...
w11legend = legend(sprintf('$D_{\\underline{1}} = %0.0f$, $D_{\\underline{2}} = %0.0f$', parameters.D1lBar_low,parameters.D2lBar_low),...
                                sprintf('$D_{\\underline{1}} = %0.0f$, $D_{\\underline{2}} = %0.0f$', parameters.D1lBar,parameters.D2lBar),'Location','northwest');
...
saveas(h, [GraphPlace,'/Proprietary_GAMMA_LAMBDA_leader'],'eps')
