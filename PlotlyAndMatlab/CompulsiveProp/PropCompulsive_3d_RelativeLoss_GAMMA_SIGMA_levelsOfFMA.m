...
colormap(gray1);
fig1=surf(parameters.SIGMA3d_high,parameters.GAMMA3d_high, transpose(reshape(Data.RelativeLossF01_highFMA_leader,[parameters.n_high,parameters.n_high])),'LineWidth',LineWidthCustom,'EdgeColor',EdgeColor.u)
set(fig1,'facealpha',0.8)
freezeColors
hold on;
colormap(gray3);
fig1=surf(parameters.SIGMA3d_high,parameters.GAMMA3d_high, transpose(reshape(Data.RelativeLossF01_lowFMA_leader,[parameters.n_high,parameters.n_high])),'LineWidth',LineWidthCustom,'EdgeColor',EdgeColor.l)
set(fig1,'facealpha',0.8)
freezeColors
...
print('../LatexFilePaper2/Relative_Proprietary_GAMMA_SIGMA_levelsFMA.eps','-depsc')
